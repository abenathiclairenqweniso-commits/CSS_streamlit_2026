...
st.markdown(
    ...
    I am passionate about **Computational Biology, Proteomics, Drug Discovery, and Molecular Biology**.
    """
)
...
if section == "About Me":
    ...
    with col2:
        st.write(
            ...
            I am an MSc student in Bioinformatics at **Rhodes University** with a strong interest in:
